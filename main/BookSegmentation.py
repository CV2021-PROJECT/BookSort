...
if __name__ == "__main__":
    paths = [
        "./data/sample_inputs/sample1.jpeg",
        "./data/sample_inputs/sample2.jpeg",
        "./data/sample_inputs/sample3.jpeg",
        "./data/sample_inputs/sample4.jpeg",
        "./data/sample_inputs/sample5.jpg",
    ]
